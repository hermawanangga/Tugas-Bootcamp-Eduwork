...
<div class="container py-5">
    ...
    <div class="mb-4">
        <h1 class="fw-bold mb-1">Belanja</h1>
    ...
    <div class="row g-4">
        ...
        <div class="col-6 col-md-4 col-lg-3">
            ...
            <div class="card h-100 border-0 shadow-sm">
                ...
                <a href="{{ route('products.show', $product->id) }}" class="text-decoration-none text-dark d-flex flex-column flex-grow-1">
                ...
                <div class="d-flex gap-2">
                    ...
                    @auth
                        @if($product->colors || $product->sizes)
                            <a href="{{ route('products.show', $product->id) }}" class="btn btn-outline-dark btn-sm w-100 flex-grow-1">
                                Pilih Varian
                            </a>
                            @else
                         ...
                         @endif
                    @else
                        <a href="{{ route('login', ['reason' => 'buy']) }}" class="btn btn-outline-dark btn-sm w-100 flex-grow-1">
                            Login untuk membeli
                        </a>
                    @endauth
