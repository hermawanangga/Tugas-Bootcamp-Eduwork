                ...
                <div class="col-md-4">
                    <a href="{{ route('admin.users.index') }}" class="text-decoration-none text-dark">
                        <div class="border rounded-3 p-4 h-100">
                            ...
                            <h5 class="fw-semibold mt-3">Kelola User</h5>
                ...
                <div class="col-md-4">
                    <a href="{{ route('admin.orders.index') }}" class="text-decoration-none text-dark">
                        <div class="border rounded-3 p-4 h-100">
                            ...
                            <h5 class="fw-semibold mt-3">Kelola Pesanan</h5>
                            <p class="text-muted small mb-0">Lihat semua pesanan yang masuk dari pelanggan.</p>
                        </div>
                    </a>
                </div>
