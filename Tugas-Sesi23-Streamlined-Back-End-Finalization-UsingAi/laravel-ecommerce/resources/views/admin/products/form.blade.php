...
<div class="mb-3">
    ...
    <div class="form-text">
        Pisahkan tiap warna dengan koma. Kosongkan jika produk ini tidak punya pilihan warna.
    </div>
...
<div class="mb-3">
    ...
    <input type="text"
           ...
           placeholder="Contoh: 36,37,38,39,40"
           value="{{ old('sizes', $product->sizes ?? '') }}">

    <div class="form-text">
        Pisahkan tiap ukuran dengan koma. Kosongkan jika produk ini tidak punya pilihan ukuran.
    </div>
